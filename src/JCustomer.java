...
public class JCustomer extends javax.swing.JFrame {
    ...
    public JCustomer() {
        ...
        list.add(new Customer("1", "vu", "dn", "123"));
        list.add(new Customer("2", "hieu", "dn", "123"));
        list.add(new Customer("3", "treu", "dn", "123"));
        list.add(new Customer("4", "thai", "dn", "123"));
        list.add(new Customer("5", "huy", "dn", "123"));
        View();
        ViewTable();
    }
